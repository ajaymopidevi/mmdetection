...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='./', seg='train/annotations/semantic_masks/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='./', seg='val/annotations/semantic_masks/'),
        test_mode=True,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='./', seg='test/annotations/semantic_masks/'),
        test_mode=True,
        pipeline=test_pipeline,
        backend_args=backend_args))
